...
| | |
|---|---|
| Backend tests | **711** passing, gated suite |
...
CALLOSUM_RUN_INTEGRATION=1 .venv/bin/python -m pytest    # 711 tests, real stores
...
must be up. Without the gate the suite selects 238 tests; with it, 711. Run it with the
