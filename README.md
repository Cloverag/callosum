...
| | |
|---|---|
| Backend tests | **703** passing, gated suite |
...
CALLOSUM_RUN_INTEGRATION=1 .venv/bin/python -m pytest    # 703 tests, real stores
...
must be up. Without the gate the suite selects 238 tests; with it, 703. Run it with the
