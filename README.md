...
| | |
|---|---|
| Backend tests | **714** passing, gated suite |
...
CALLOSUM_RUN_INTEGRATION=1 .venv/bin/python -m pytest    # 714 tests, real stores
...
must be up. Without the gate the suite selects 249 tests; with it, 714. Run it with the
