...
_Run: 2026-07-18 02:53 · ollama · gpt-oss:120b-cloud_
...
| temporal | 4 | 4/4 | 4/4 | 100% |
| aliases | 4 | 2/4 | 0/4 | 100% |
| conflict | 2 | 2/2 | 1/2 | 100% |
| coreference | 2 | 0/2 | 1/2 | 100% |
| messy_email | 2 | 2/2 | 2/2 | 100% |
| grounding_adv | 4 | 3/4 | 3/4 | 100% |
...
| Linker (given the entity was offered) | 81% |
| Entity grounding (correct seed) | 81% (17/21) |
...
| Lost — entity offered, linker chose wrong | 19% |
| Grounded correctly | 81% |
...
Stage latency: candidate 246 ms (embedding + store lookup) · planner 4427 ms (LLM). Both are per question and exclude synthesis.
...
|---|---|---|---|---|---|---|---|---|---|---|
| L1 | lookup | board_meeting_12_transcript | Raj | — | — | ✓ | ✓ | 28 | — | What was decided about Pricing Model B? |
| L2 | lookup | board_meeting_12_transcript | Raj | — | — | ✓ | ✓ | 0 | — | What did the margin analysis say gross margin would drop to under Model B? |
| L3 | lookup | board_meeting_12_transcript | Raj | — | — | ✓ | ✗ | 0 | — | How many months of runway does the company have? |
| R1 | relational | board_meeting_12_transcript | Raj | ✓ | Pricing Model B, Reject Pricing Model B | ✓ | ✓ | 56 | 100% | Who opposed rejecting Pricing Model B? |
...
| R3 | relational | board_meeting_12_transcript | Raj | ✓ | Pricing Model B, Reject Pricing Model B | ✓ | ✓ | 56 | 100% | Who supported the rejection of Pricing Model B? |
...
| T2 | temporal | board_meeting_12_transcript, board_meeting_13_transcript | Raj | ✓ | Reject Pricing Model B, Pricing Model B | ✓ | ✓ | 56 | 100% | What decision reversed the earlier pricing rejection, and who made the call? |
| T3 | temporal | board_meeting_12_transcript, board_meeting_13_transcript | Raj | ✓ | Pricing Model B, Reject Pricing Model B | ✓ | ✓ | 56 | 100% | Why was the pricing decision reversed? |
...
| C1 | conflict | finance_fy27_forecast, sales_fy27_forecast, board_meeting_15_transcript | Raj | ✓ | Finance FY27 ARR forecast, Sales FY27 ARR forecast | ✓ | ✓ | 10 | 100% | What FY27 ARR forecasts conflict, and which source reported each? |
| C2 | conflict | finance_fy27_forecast, sales_fy27_forecast, board_meeting_15_transcript | Raj | ✓ | FY27 ARR forecast, Finance FY27 ARR forecast, Sales FY27 ARR forecast | ✓ | ✗ | 14 | 100% | Which FY27 ARR forecast should the board treat as the winner? |
| K1 | coreference | board_meeting_16_transcript | Raj | ✓ | Pricing rollout plan | ✗ | ✓ | 25 | 100% | What does “that proposal” refer to in Meeting 16, and who owns it? |
| K2 | coreference | board_meeting_16_transcript | Raj | — | — | ✗ | ✗ | 44 | — | What does “the prior motion” refer to in Meeting 16? |
...
| A3 | grounding_adv | board_meeting_12_transcript | Raj | ✓ | Reject Pricing Model B | ✓ | ✓ | 43 | 100% | Who backed dropping the metered-billing plan? |
